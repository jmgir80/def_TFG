...
package in2.liferay.crud.horari.service.base;
...
/**
 * Provides the base implementation for the horari local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link in2.liferay.crud.horari.service.impl.HorariLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see in2.liferay.crud.horari.service.impl.HorariLocalServiceImpl
 * @generated
 */
public abstract class HorariLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, HorariLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>HorariLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>in2.liferay.crud.horari.service.HorariLocalServiceUtil</code>.
	 */
	...
	public Horari addHorari(Horari horari) {
		...
		return horariPersistence.update(horari);
	}
	...
	public Horari createHorari(long fooId) {
		return horariPersistence.create(fooId);
	}
	...
	public Horari deleteHorari(long fooId) throws PortalException {
		return horariPersistence.remove(fooId);
	}
	...
	public Horari deleteHorari(Horari horari) {
		return horariPersistence.remove(horari);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Horari.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return horariPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return horariPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return horariPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return horariPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return horariPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Horari fetchHorari(long fooId) {
		return horariPersistence.fetchByPrimaryKey(fooId);
	}
	...
	public Horari fetchHorariByUuidAndGroupId(String uuid, long groupId) {
		return horariPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public Horari getHorari(long fooId) throws PortalException {
		return horariPersistence.findByPrimaryKey(fooId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(horariLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Horari.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(horariLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Horari.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<Horari>() {

				@Override
				public void performAction(Horari horari)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, horari);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return horariPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return horariLocalService.deleteHorari((Horari)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return horariPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Horari> getHorarisByUuidAndCompanyId(
		...
		return horariPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<Horari> getHorarisByUuidAndCompanyId(
		...
		return horariPersistence.findByUuid_C(
	...
	public Horari getHorariByUuidAndGroupId(String uuid, long groupId)
		...
		return horariPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<Horari> getHoraris(int start, int end) {
		return horariPersistence.findAll(start, end);
	}
	...
	public int getHorarisCount() {
		return horariPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			HorariLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		horariLocalService = (HorariLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return HorariLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = horariPersistence.getDataSource();
	...
	protected HorariLocalService horariLocalService;

	@Reference
	protected HorariPersistence horariPersistence;
